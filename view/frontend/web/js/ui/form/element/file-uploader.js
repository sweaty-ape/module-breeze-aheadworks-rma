...
], function ($, _, utils, uiAlert, validator, Component, notification, $t) {
    'use strict';

    return Component.extend({
        component: 'Aheadworks_Rma/js/ui/form/element/file-uploader', // Breeze fix: Added component name
        defaults: {
            template: 'Aheadworks_Rma/form/element/uploader/v247/uploader', // Breeze fix: Added default template
            value: [],
            aggregatedErrors: [],
            maxFileSize: false,
